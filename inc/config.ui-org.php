...
$page_nav = array(
	...
	"open" => array(
		...
		"sub" => array(
			"fault ticket" => array(
				"title" => "Fault Ticket",
				"url" => APP_URL."/ft_frm_open.php"
			),
			"job order" => array(
				"title" => "Job Order",
				"url" => APP_URL."/joborder.php"
			)
		)
	),
	"customer" => array(
		...
		"sub" => array(
			"normal" => array(
				"title" => "ADD Customer",
				"url" => APP_URL."/customer_add.php"
			),
			"data" => array(
				"title" => "Search Customer",
				"url" => APP_URL."/customer_view.php"
			)
	...
	"equipment" => array(
		...
		"sub" => array(
			"normal" => array(
				"title" => "ADD Equipment",
				"url" => APP_URL."/equipment_add.php"
			),
			"data" => array(
				"title" => "Search Equipment",
				"url" => APP_URL."/equipment_view.php",
	...
	"user" => array(
		...
		"sub" => array(
			"normal" => array(
				"title" => "ADD User",
				"url" => APP_URL."/adduser.php"
			),
			"data" => array(
				"title" => "Search User",
				"url" => APP_URL."/user_view.php",
				"label_htm" => ' <span class="badge inbox-badge bg-color-greenLight">v1.10</span>'
			)
