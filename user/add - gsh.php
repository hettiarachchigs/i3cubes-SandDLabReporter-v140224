...
if($_POST['but']=='save'){
    ...
    $lat = $_POST['lat'];
    $lon = $_POST['lon'];
    $emp_id=$emp->addEmployee($_POST['emp_name'], $_POST['emp_address'], $_POST['emp_nic'], '', $_POST['emp_mobile'], $_POST['emp_email'], $_POST['emp-Designation'], '', $_POST['note'],"",$lat,$lon);
    if($emp_id){
        $res_user=$us->addUser($_POST['usr_username'], $_POST['usr_psw'], $emp_id);
    }
    else{
        $res_user=false;
    }
                            ...
                            <form id="form_add" class="smart-form" method="post" action="<?php echo str_replace('.php','',htmlentities($_SERVER['PHP_SELF']));?>">
									...
									<fieldset>
										...
										<div class="row">
											...
											<section class="col-xs-7 col-sm-7 col-md-7">
												<label class="input">
													<input type="text" name="lat" id="lat" placeholder="Latitude" value="">
												</label>
											</section>	
											<section class="col-xs-1 col-sm-1 col-md-1">
											...
											<section class="col-xs-7 col-sm-7 col-md-7">
												<label class="input">
													<input type="text" name="lon" id="lon" placeholder="Longitude" value="">
												</label>
											</section>	
											<section class="col-xs-1 col-sm-1 col-md-1">
