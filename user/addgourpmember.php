...
if ($_POST['but'] == 'save') {
    ...
    $empl = new employee($empID);
    $arry_mem = $empl->getTeam();

    $team = new team($teamID);

    if (count($arry_mem) > 0) {
        $msg = "<br><span style='color: red;' >Error Occur !Emplyee already registerd in a group </span>";
        $close = 2;
    } else {
        $team->addMembers($empID, "M");
        $close = 1;
    }

//    if ($close == 1) {
//        $msg = "<br><span style='color: #009926;' > !</span>";
//    } else if ($close == 2) {
//         }
}
                ...
                <article class="col-sm-12 col-md-12 col-lg-12">
                    ...
                    <div class="jarviswidget" id="wid-id-500" 
                        ...
                        <header>
                            ...
                            <span style="margin-left: 20px;"><h2>Add Group Member</h2></span>				
...
<!--                                                <strong>Qty Issued:</strong>-->
                                            ...
                                            <section class="col-xs-7 col-sm-7 col-md-7">
                                                <label class="input"> 	<i class="icon-append fa fa-user"></i> 									
                                                    <input type="text" autocomplete="false" name="memb" id="memb" value="" placeholder="Employee">
