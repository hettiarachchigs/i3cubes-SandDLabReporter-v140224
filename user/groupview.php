...
$page_nav["acc"]["sub"]["grm"]["active"] = true;
include("../inc/nav.php");
...
$fn = new functions();
$team1 = new team();
$mygroup = $team1->getMyGroupDetails($_SESSION['EMPID']);

if ($mygroup["group_id"] == "") { //EMPID notavalable group
    ?>
        ...
        <div id="content">
            <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div role="widget" class="jarviswidget" id="wid-id-fte-2"
                    ...
                    <div>
                        <label style="color: red;" >Sorry ! Currently you haven't any Group</label>
                    </div>
                </div>
            </article>
        </div>
...
//                                     <th data-hide='phone'>Qty WS In</th>
                                ...
                                foreach ($arrayitm as $row) {   //Creates a loop to loop through results
                                    if ($row["type"] == "L") {
                                        ...
                                        $rowremove = " <button type='submit' id='but' class='btn btn-primary btn-xs' name='but' value='delete'  >Remove</button>";
                                    }
                                    ...
                                    . "<input type='hidden' value=" . $id . " name='gid'  ><input type='hidden' value=" . $row["id"] . " name='emp_id'  >
                                                    " . $rowremove . "
                                                    </form></td>
                                                                     <td> <button type='button' id='but'  onclick='editmem(" . $row["id"] . ")' class='btn btn-primary btn-xs' name='but' value='edit'  >Edit</button>   </td>
