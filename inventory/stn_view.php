                    ...
                    <div class="jarviswidget" id="wid-id-23"
                        ...
                        <div>
                            ...
                            <div class="widget-body no-padding">
                                ...
                                $stn = new \stn();
                                $stn_mgr = new stnManager();
                                $ary_stn = $stn_mgr->searchSTN($jo_s_from, $jo_s_to, $jo_s_vid);
                                    ...
                                    echo "<table id='t_raw_search' class='table table-bordered table-hover' width='100%' >
                                            <thead>
                                                ...
                                                <th data-hide='phone'>Date</th>
                                                 ...
                                                 <th data-hide='phone'>Fault Ticket</th>
                                                 <th data-hide='phone'>Status</th>
                                                </tr>
                                            </thead>";
                                    $i = 1;
                                    print '<tbody>';
                                    foreach ($ary_stn as $stn) {   //Creates a loop to loop through results
                                        $ft = new fault_ticket($stn->ft_id);
                                        $ft->getData();
                                        if($stn->status_id==constants::$STN_CONF){
                                            $flg="ft_closed";
                                        }
                                        else if($stn->status_id==constants::$STN_DELETED){
                                            $flg="ft_cancelled";
                                        }
                                        else{
                                            $flg="";
                                        ...
                                        echo "
                                                <tr id=" . '"' . $stn->id . '" class="ngs-popup ' . $flg . '"' . ">	  
                                                <td>" . $i . "</td>
                                                <td>" . $stn->ref_no . "</td>
                                                <td>" . $stn->date_added . "</td>
                                                <td>" . $stn->from_customer_name . "</td>
                                                 <td>" . $stn->to_customer_name . "</td>
                                                 <td>" . $ft->ref_no . "</td>
                                                 <td>" . $stn->status_name."</td>
                                                </tr>";
                                        $i++;
                                    }
                                    print '</tbody>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('.ngs-popup').click(function () {
            var id = this.id;
            var url = 'stn_add?<?php print SID ?>&inv_stn_id=' + id;
