...
$jscomp.polyfillUnisolated = function (a, h, k, e) {
    ...
    e = k[a];
    h = h(e);
    h != e && null != h && $jscomp.defineProperty(k, a, { configurable: !0, writable: !0, value: h });
};
$jscomp.polyfillIsolated = function (a, h, k, e) {
    ...
    null != h &&
        (a
            ? $jscomp.defineProperty($jscomp.polyfills, d, { configurable: !0, writable: !0, value: h })
            : h !== k &&
              ...
              $jscomp.defineProperty(e, d, { configurable: !0, writable: !0, value: h })));
};
...
$jscomp.polyfill(
    ...
    function (a) {
        ...
        e.prototype.set = function (c, b) {
            ...
            f.entry
                ? (f.entry.value = b)
                : ((f.entry = { next: this.head_, previous: this.head_.previous, head: this.head_, key: c, value: b }), f.list.push(f.entry), (this.head_.previous.next = f.entry), (this.head_.previous = f.entry), this.size++);
            return this;
        };
    ...
    var a,
        ...
        k = (function () {
            function e(d, g) {
                ...
                g = { "background-color": "white", bottom: "0px", display: "block", position: "absolute", width: this.s.barWidth + 1 + "px" };
                this.dom = {
                    leftBottomBlocker: a("<div>").css(g).css("left", 0).addClass(this.classes.leftBottomBlocker),
                    leftTopBlocker: a("<div>").css(g).css({ left: 0, top: 0 }).addClass(this.classes.leftTopBlocker),
                    rightBottomBlocker: a("<div>").css(g).css("right", 0).addClass(this.classes.rightBottomBlocker),
                    rightTopBlocker: a("<div>").css(g).css({ right: 0, top: 0 }).addClass(this.classes.rightTopBlocker),
                };
            ...
            e.prototype._addStyles = function () {
                ...
                for (var b = this.s.dt.columns().data().toArray().length, f = 0, l = 0, u = a(this.s.dt.table().node()).children("tbody").children("tr"), x = 0, A = new Map(), r = 0; r < b; r++) {
                    ...
                    if (t.visible()) {
                        ...
                        if (r - x < this.c.left) {
                            ...
                            if (0 < r - x)
                                for (var p = r; p + 1 < b; ) {
                                    var q = this.s.dt.column(p - 1, { page: "current" });
                                    if (q.visible()) {
                            ...
                            v = 0;
                            for (w = u; v < w.length; v++) (p = w[v]), (p = a(a(p).children()[r - x])), p.hasClass(this.classes.fixedLeft) && p.css(this._clearCellCSS("left")).removeClass(this.classes.fixedLeft);
                ...
                null === g || g.hasClass("index") || (this.s.rtl ? (this.dom.leftTopBlocker.outerHeight(m), d.append(this.dom.leftTopBlocker)) : (this.dom.rightTopBlocker.outerHeight(m), d.append(this.dom.rightTopBlocker)));
                ...
                for (r = b - 1; 0 <= r; r--)
                    if (((t = this.s.dt.column(r)), t.visible()))
                        if (((y = a(t.header())), (t = a(t.footer())), (w = A.get(r)), void 0 === w && (w = x), r + v >= b - this.c.right)) {
                            ...
                            q = 0;
                            for (z = u; q < z.length; q++) (p = z[q]), (p = a(a(p).children()[r - w])), p.hasClass(this.classes.fixedRight) && p.css(this._clearCellCSS("right")).removeClass(this.classes.fixedRight);
                ...
                g && (this.s.rtl ? (this.dom.leftTopBlocker.outerHeight(m), d.append(this.dom.leftTopBlocker)) : (this.dom.rightTopBlocker.outerHeight(m), d.append(this.dom.rightTopBlocker)));
            ...
            e.prototype._getCellCSS = function (d, g, m) {
                return "left" === m
                    ? this.s.rtl
                        ? { position: "sticky", right: g + (d ? this.s.barWidth : 0) + "px" }
            ...
            e.prototype._clearCellCSS = function (d) {
                return "left" === d ? (this.s.rtl ? { position: "", right: "" } : { left: "", position: "" }) : this.s.rtl ? { left: "", position: "" } : { position: "", right: "" };
            };
            e.prototype._setKeyTableListener = function () {
                ...
                this.s.dt.on("key-focus", function (g, m, n) {
                    ...
                    0 < d.c.right &&
                        ...
                        g.left + n > b.left && ((c = m.scrollLeft()), m.scrollLeft(c - (b.left - (g.left + n)))));
                });
    ...
    (function (e) {
        "function" === typeof define && define.amd
            ...
            ? (module.exports = function (d, g) {
                  d || (d = window);
                  (g && g.fn.dataTable) || (g = require("datatables.net")(d, g).$);
        ...
        e.fn.dataTable.ext.buttons.fixedColumns = {
            action: function (c, b, f, l) {
                e(f).attr("active")
                    ? (e(f).removeAttr("active").removeClass("active"), b.fixedColumns().left(0), b.fixedColumns().right(0))
                    : (e(f).attr("active", !0).addClass("active"), b.fixedColumns().left(l.config.left), b.fixedColumns().right(l.config.right));
            },
